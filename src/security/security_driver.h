...
typedef int (*virSecurityDomainReleaseLabel) (virSecurityManagerPtr mgr,
                                              virDomainDefPtr sec);
/*add vtpmpath parameter by chenmeng*/
...
/*add by chenmeng*/
/*
typedef int (*virSecurityDomainSetVtpmLabel) (virDomainDefPtr def,
                                                   char *vtpmpath);*/
struct _virSecurityDriver {
  ...
  //  virSecurityDomainSetVtpmLabel domainSetVtpmLabel;//add by chenmeng
};
