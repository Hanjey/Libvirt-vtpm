...
#define DMIDECODE "/sbin/dmidecode"

/* Location or name of the dmsetup program */
/* #undef DMSETUP */

/* Location or name of the dnsmasq program */
#define DNSMASQ "/sbin/dnsmasq"
...
#define PACKAGE_STRING "libvirt 1.2.17"
